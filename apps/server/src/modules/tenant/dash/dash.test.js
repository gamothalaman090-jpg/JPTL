...
describe('Tenant Dashboard Module API (/api/tenant/dash)', () => {
  it('GET /api/tenant/dash - should return complete overview payload for tenant', async () => {
  ...
  it('GET /api/tenant/dash/kpi - should return quick summary KPI numbers', async () => {
    const res = await request(app)
