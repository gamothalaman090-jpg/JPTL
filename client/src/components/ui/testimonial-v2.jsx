            ...
            <React.Fragment key={index}>
              {testimonials.map(({ text, image, name, role }, i) => (
                <motion.li 
                  ...
                  className="p-8 rounded-3xl border border-slate-200 dark:border-white/10 shadow-md shadow-slate-200/50 dark:shadow-black/30 max-w-xs w-full bg-white dark:bg-[#10101A] transition-all duration-300 cursor-default select-none group focus:outline-none focus:ring-2 focus:ring-blue-500/30" 
                >
                  <blockquote className="m-0 p-0">
                    <p className="text-slate-700 dark:text-slate-300 leading-relaxed font-sans text-xs sm:text-sm font-normal m-0 transition-colors duration-300">
                      "{text}"
                    </p>
                    <footer className="flex items-center gap-3 mt-6">
                      <img
                        ...
                        src={image}
                        alt={`Avatar of ${name}`}
                        className="h-10 w-10 rounded-full object-cover ring-2 ring-slate-200 dark:ring-white/10 group-hover:ring-blue-500/50 transition-all duration-300 ease-in-out"
                      />
                      <div className="flex flex-col">
                        <cite className="font-grotesk font-bold not-italic tracking-tight leading-5 text-slate-900 dark:text-white text-sm transition-colors duration-300">
                          {name}
                        </cite>
                        <span className="text-xs leading-5 tracking-tight text-slate-500 dark:text-slate-400 font-sans mt-0.5 transition-colors duration-300">
                          {role}
                        </span>
                      </div>
                    </footer>
...
export function TestimonialsV2() {
  return (
    <section 
      ...
      className="bg-slate-50 dark:bg-[#08080C] py-24 relative overflow-hidden border-t border-slate-200 dark:border-white/10 z-10 font-sans transition-colors duration-300"
    >
      <motion.div 
      ...
      >
        <div className="flex flex-col items-center justify-center max-w-[540px] mx-auto mb-16 text-center">
          <div className="flex justify-center">
            <div className="border border-blue-500/20 py-1 px-4 rounded-full text-xs font-mono font-semibold tracking-wide uppercase text-blue-600 dark:text-blue-400 bg-blue-500/10 transition-colors flex items-center gap-1.5">
              <Sparkles className="w-3.5 h-3.5" />
              <span>TESTIMONIALS</span>
            </div>
          </div>

          <h2 id="testimonials-heading" className="font-grotesk text-3xl sm:text-5xl font-extrabold tracking-tight mt-4 text-slate-900 dark:text-white">
            What our users say
          </h2>
