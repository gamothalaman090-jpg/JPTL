...
export const RoleBreakdown = ({ onOpenLogin }) => {
  ...
  return (
    <section id="roles" className="py-24 bg-[#08080C] relative border-t border-white/10 overflow-hidden z-10">
      ...
      <div className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            {/* Display Title */}
            <div>
              <span className="font-mono text-xs text-blue-400 font-semibold tracking-widest uppercase mb-2 block">
                Role-Based Access Control (RBAC)
              </span>
              <h2 className="font-grotesk text-4xl sm:text-6xl font-black text-white tracking-tight uppercase leading-none">
                CONTROL EVERY <br />
                <span className="gradient-shimmer">PERSONA.</span>
              </h2>
              <p className="font-sans text-sm sm:text-base text-slate-400 mt-4 font-normal leading-relaxed">
                ...
                return (
                  <motion.div
                    ...
                    className={`p-5 rounded-2xl border transition-all cursor-pointer relative overflow-hidden ${
                      isActive
                        ? 'bg-[#141422] border-white/30 shadow-xl'
                        : 'bg-[#0E0E16]/80 border-white/10 hover:border-white/20 opacity-70 hover:opacity-100'
                    }`}
                    whileHover={{ x: 4 }}
                  ...
                  >
                    ...
                    <h3 className="font-grotesk font-black text-lg sm:text-xl text-white tracking-tight">
                      {step.title}
                    </h3>
          ...
          {/* Right Column: macOS Style App Window (Shifted right & squarer aspect ratio) */}
          <div className="lg:col-span-7 lg:pl-4">
            <div className="rounded-3xl border border-white/15 bg-[#0C0C14] shadow-2xl overflow-hidden spotlight-card glow-card aspect-[4/3] flex flex-col min-h-[460px] sm:min-h-[520px]">
              
              {/* macOS Window Titlebar */}
              <div className="px-5 py-3.5 bg-[#08080E] border-b border-white/10 flex items-center justify-between shrink-0">
                <div className="flex items-center gap-2">
                  ...
                  <div className="ml-3 px-3.5 py-1 rounded-lg bg-[#141420] border border-white/10 text-slate-400 font-mono text-xs flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-3.5 py-1.5 rounded-xl bg-white hover:bg-slate-100 text-slate-950 font-grotesk font-bold text-xs flex items-center gap-1.5 btn-press shadow-md"
                >
              ...
              <div className="p-6 sm:p-8 flex-1 flex items-center justify-center relative overflow-y-auto">
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div className="p-6 rounded-2xl bg-[#141422] border border-white/10 relative overflow-hidden shadow-xl">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            <div className="font-grotesk font-black text-white text-lg">
                              {currentStep.title}
                            </div>
                    ...
                    {activeStep === 0 && (
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {/* Tenant Widget 1 */}
                        <div className="p-4 rounded-xl bg-[#0E0E18] border border-white/10 space-y-2">
                          <div className="flex items-center justify-between text-xs font-grotesk text-blue-400 font-bold">
                        ...
                        {/* Tenant Widget 2 */}
                        <div className="p-4 rounded-xl bg-[#0E0E18] border border-white/10 space-y-2">
                          <div className="flex items-center justify-between text-xs font-grotesk text-emerald-400 font-bold">
                    ...
                    {activeStep === 1 && (
                      <div className="space-y-3">
                        <div className="p-4 rounded-xl bg-[#0E0E18] border border-white/10 flex items-center justify-between text-xs">
                          <div>
                            <div className="font-grotesk font-bold text-white">Aura Sky Towers • Unit 2B</div>
                            <div className="text-[10px] text-slate-400 font-sans">Sophia Lin (Tenant) • Rent $2,400/mo</div>
                          </div>
                          <span className="px-3 py-1 rounded-full font-mono text-[10px] font-bold bg-amber-500/10 text-amber-400 border border-amber-500/20">
                            IN_PROGRESS
                          </span>
                        </div>
                        ...
                        <div className="p-4 rounded-xl bg-[#0E0E18] border border-white/10 flex items-center justify-between text-xs">
                          <div>
                            <div className="font-grotesk font-bold text-white">Zenith Lofts • Unit 4A</div>
                            <div className="text-[10px] text-slate-400 font-sans">Alexander Vance (Landlord) • Rent $3,100/mo</div>
                          </div>
                          <span className="px-3 py-1 rounded-full font-mono text-[10px] font-bold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
                            RESOLVED
                          </span>
                        </div>
                      </div>
                    ...
                    {activeStep === 2 && (
                      <div className="p-4 rounded-xl bg-[#0E0E18] border border-white/10 space-y-2.5 font-mono text-xs">
                        <div className="text-[10px] text-slate-500 uppercase tracking-wider pb-1 border-b border-white/10 flex justify-between">
                        ...
                        <div className="flex justify-between items-center text-pink-300 text-[11px]">
                          <span>15:58:20</span>
                    ...
                    <div className="pt-2 grid grid-cols-2 gap-2 text-xs font-sans text-slate-300">
                      <div className="flex items-center gap-2">
